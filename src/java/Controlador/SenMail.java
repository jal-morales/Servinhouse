...
{      
    ...
    {
          try {
                 SenMail enviar= new SenMail();
          enviar.enviarCorreo("jal.morales89@gmail.com", "17336928-k", "jal.morales89@gmail.com", "prueba de envio", "Recuperar clave");
                System.out.println("envio enviado correctamente");
          } catch (Exception e) 
          {
                System.out.println("no se envio correo correctamente");
                e.printStackTrace();
          }
